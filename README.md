...
* Utilisation des concepts de classe et d'instance
* Maîtrise du concept d'héritage et de polymorphisme
...
Le lancement affiche une image donc pour devez avoir downloard au prealable les ressources pour le npm-image et ensuite xecuter la commande : deno task start